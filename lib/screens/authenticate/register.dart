            ...
            key: _formKey,
              child: Column(
                children: <Widget>[
                  ...
                  const SizedBox(height: 20),
                  TextFormField(
                    decoration: textInputDecoration.copyWith(hintText: 'Tell us more about you!'),
                    // validator: (val) => val!.isEmpty ? "Enter your email" : null,
                    onChanged: (val){
                  ...
                  const SizedBox(height: 20),
                  TextFormField(
                    decoration: textInputDecoration.copyWith(hintText: 'Where do you study?'),
                    // validator: (val) => val!.isEmpty ? "Enter your email" : null,
                    onChanged: (val){
                  ...
                  ElevatedButton(
                      ...
                      onPressed: () async {
                        if (_formKey.currentState!.validate()) {
                          ...
                          dynamic result = await _auth.registerWithEmailAndPassword(email, password, name, details, category, affiliation);
                          if (result == null){
                            setState(() {
