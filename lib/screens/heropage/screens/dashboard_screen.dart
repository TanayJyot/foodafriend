                                            ...
                                            children: [
                                              ...
                                              Row(
                                                children: [
                                                  ...
                                                  SizedBox(width: 5.w,),
                                                  const Text("35-40 min ● 1 km"),
                                                  const Spacer(),
                                                  const Text("\$150 for one"),SizedBox(width: 5.w,)
                                                ],
                                              ),
                                            ],
                                          ),
                                        ...
                                        child: Container(
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Row(
                                                children: [
                                                  const Text("Gujarat ● North India ● Chinese",style: TextStyle(color: Colors.white),),SizedBox(width: 100.w,),
                                                  Container(
                                                    ...
                                                    child: Padding(
                                                      padding:  EdgeInsets.symmetric(horizontal:5.w),
                                                      child: const Text("4.0★",style: TextStyle(color: Colors.white),),
                                                    ),
                                                  )
                                                ],)
                                            ],
