                    ...
                    child: IntrinsicHeight(
                      child: Row(
                        children: [
                          ...
                          const Icon(Icons.keyboard_voice_outlined,color: Colors.pink,),SizedBox(width: 10.w,)
                        ],
                      ),
                    ),
                  ),
                                    ...
                                    child: Stack(
                                      children: [
                                        ...
                                        Positioned(
                                            left: 5.w,
                                            bottom: 20.h,
                                            child: const Text("Collection 1",style: TextStyle(fontSize:18,color: Colors.white),))
                                      ],
                                    )),
                              );
                            },
                                  ...
                                  children: [
                                        ...
                                        Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Row(
                                                children: [
                                                  ...
                                                  Container(
                                                    ...
                                                    child: Padding(
                                                      padding:  EdgeInsets.symmetric(horizontal:5.w),
                                                      child: const Text("4.9★",style: TextStyle(color: Colors.white),),
                                                    ),
                                                  )
                                                ],
                                              ),
                                              ...
                                              const Text("Kothi Compound ,Rajkot"),
                                            ],
                                          ),
                                        )
                                      ],
                                    ...
                                    Positioned(
                                        ...
                                        child: Container(
                                          ...
                                          child: IconButton(
                                            color: Colors.white,
                                            onPressed: (){},icon: const Icon(Icons.favorite_outline,color: Colors.pink,),),
                                        )
                                    ),
                                    Positioned(
                                        right: 10.w,
